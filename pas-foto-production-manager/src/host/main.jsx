...
(function (api) {
  ...
  function createSlot(doc, parent, slot, origin, mode) {
    ...
    drawOffsetBorder(parent, top, left, fw, fh, offsetBorder, baseName, slot.slotId);
    return clipGroup;
  }
    ...
    try {
      ...
      for (i = 0; i < layout.sheets.length; i++) {
        ...
        for (j = 0; j < sheet.slots.length; j++) {
          createSlot(doc, parent, sheet.slots[j], origin, mode);
          totalSlots++;
        }
